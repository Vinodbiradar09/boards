      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Platform metrics showing the progression from organizations to
            checklist items
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-4 xl:gap-6">
          {statsData.map((stat, index) => (
            <React.Fragment key={stat.key}>
              <Card className="bg-white dark:bg-zinc-800 border-gray-200 dark:border-zinc-700 w-full lg:w-auto lg:min-w-37.5 xl:min-w-45s">
